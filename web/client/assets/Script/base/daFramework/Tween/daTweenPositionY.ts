...
@ccclass
export default class daTweenPositionY extends daTweenBase {
    @property
    ...
    protected tweenUpdate(_deltaTime: number) {
        ...
        if (this.isPlaying && this.t_From != null && this.t_To != null) {
            this.Target.y = this.t_From + (this.t_To - this.t_From) * this.TweenValue;
        }
    ...
    public To(_to: number) {
        ...
        if ((this.t_From == null || this.t_From == 0) && this.isTarget) {
            this.t_From = this.Target.position.y;
        }
        return this;
    }
    ...
    public static Tween(target?: cc.Node): daTweenPositionY {
        let _node = new cc.Node("daTweenPositionY");
        _node.parent = cc.director.getScene();
        let _tween = _node.addComponent(daTweenPositionY);
